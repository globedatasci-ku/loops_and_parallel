...
* If you think you'll be using the loop more than once embed the loop into a function. To read more about function check out: https://github.com/globedatasci-ku/functions
---
...
# When to use and general advisie
...
* Allows you to do a rowise/colwise operations (`apply()`)
...
Similar ro apply but adds a progress bar (can't see in the slide format)
...
* Register a parallel backend - with one of the packages `doParallel`, `doMC`, or `doMPI`
